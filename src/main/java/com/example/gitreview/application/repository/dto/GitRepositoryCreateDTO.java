...
public class GitRepositoryCreateDTO {
    ...
    @NotNull(message = "Repository name is required")
    ...
    // 默认构造函数
    public GitRepositoryCreateDTO() {
    }

    // 全参构造函数
    public GitRepositoryCreateDTO(String name, String url, String description,
                                 String username, String password, Boolean testConnection) {
        this.name = name;
        this.url = url;
